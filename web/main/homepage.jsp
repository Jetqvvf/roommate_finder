        ...
        <div>
            ...
            <div id="unknown">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="../user/sign_up.jsp"><span class="glyphicon glyphicon-user"></span> Sign up</a></li>
                    <li><a href="../user/sign_in.jsp"><span class="glyphicon glyphicon-log-in"></span> Sign in</a></li>
                </ul>
            </div>
...
<div class="container" style="padding-top: 100px">
    <div class="row">
        <div class="col-sm-5">
            ...
            <p class="lead">Roommate finder is a development platform inspired by the way you work. From open source to business, you can host and review code, manage projects, and build software alongside 28 million developers.</p>
        </div>
        <div class="col-sm-5 col-sm-offset-1">
            <form class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="firstname" placeholder="Please input your username">
                    </div>
                </div>
                <div class="form-group">
                    <label for="lastname" class="col-sm-2 control-label">Password</label>
                    <div class="col-sm-10">
                        <input type="password" class="form-control" id="lastname" placeholder="Input your password">
                    </div>
                </div>
                <div class="form-group">
